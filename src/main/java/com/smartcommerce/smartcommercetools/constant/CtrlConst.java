package com.smartcommerce.smartcommercetools.constant;
...
public class CtrlConst {
	...
	public static final String PRODUCT_UPDATE_URL = "/product/update";
	...
	public static final String PRODUCT_DETAILS_PAGE = "productDetailsPage";
